...
<title>Probitanima11.GitHub.io by probitanima11</title>
...
<body>
	<div class="wrapper">
		<header>
			<h1>Probitanima11.GitHub.io</h1>
			<p>probitanima11 blog page</p>
			<p class="view">
				<a href="https://github.com/probitanima11"> View My GitHub
					Profile </a>
			</p>
			<p class="view">
				<a href="/post/web/web.html"> Web </a>
			</p>
		</header>
		<section>
			<h3>
